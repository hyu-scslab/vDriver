...
#define DEFAULT_MYSQL_HOME "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run"
#define SHAREDIR "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/share"
#define DEFAULT_BASEDIR "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run"
#define MYSQL_DATADIR "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/data"
#define MYSQL_KEYRINGDIR "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/keyring"
#define DEFAULT_CHARSET_HOME "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run"
#define PLUGINDIR "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/lib/plugin"
#define DEFAULT_SYSCONFDIR "/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0"
