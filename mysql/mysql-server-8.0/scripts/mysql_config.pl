...
my $socket  = '/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/mysql.sock';
my $version = '8.0.17';
...
my $ldata   = '/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/data';
my $execdir = '/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/bin';
my $bindir  = '/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/opt/sm1725-1/jaeseon/mysql/mysql-server-8.0/run/include', "include/mysql", "include");
...
my $flags;
$flags->{libs} = [@lib_opts, qw(-lpthread -lm -lrt -lssl -lcrypto -ldl)];
