...
#ifdef HYU 
  LATCH_ADD_RWLOCK(VDEAD_SYS_LATCH, SYNC_DEAD_RWLOCK, dead_sys_latch_key);
#endif /* HYU */
...
#ifdef HYU
	LATCH_ADD_MUTEX(VCLU_DESC_MUTEX, SYNC_NO_ORDER_CHECK, PFS_NOT_INSTRUMENTED);
	LATCH_ADD_MUTEX(VCACHE_LRU_MUTEX, SYNC_NO_ORDER_CHECK, PFS_NOT_INSTRUMENTED);
	LATCH_ADD_MUTEX(VCACHE_FREE_LIST_MUTEX, SYNC_NO_ORDER_CHECK, PFS_NOT_INSTRUMENTED);
#endif /* HYU */
