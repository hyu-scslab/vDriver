...
#ifdef HYU /* LATCH_ID */
  LATCH_ID_VCLU_DESC_MUTEX, 		// [HYU SCSLAB]
  LATCH_ID_VCACHE_LRU_MUTEX, 		// Three kind of mutexes
  LATCH_ID_VCACHE_FREE_LIST_MUTEX, 	// used in vDriver
  LATCH_ID_VDEAD_SYS_LATCH,
#endif
  LATCH_ID_TEST_MUTEX,
