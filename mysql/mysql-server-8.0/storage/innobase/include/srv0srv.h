...
#ifdef HYU
  /** Version driver dead thread. */
  IB_thread m_vdriver_dead;

  /** Version driver cut thread. */
  IB_thread m_vdriver_cut;

  /** Version driver stats thread. */
  IB_thread m_vdriver_stats;
#endif
...
#ifdef HYU
/** The vDriver dead thread waits on this event. */
extern os_event_t srv_vdriver_dead_event;

/** The vDriver cutter thread waits on this event. */
extern os_event_t srv_vdriver_cut_event;

/** The vDriver stas thread waits on this event. */
extern os_event_t srv_vdriver_stats_event;
#endif
...
#ifdef HYU
extern mysql_pfs_key_t vdriver_dead_thread_key;
extern mysql_pfs_key_t vdriver_cut_thread_key;
extern mysql_pfs_key_t vdriver_stats_thread_key;
#endif /* HYU */
