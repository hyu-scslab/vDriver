...
#ifdef HYU
	PSI_RWLOCK_KEY(dead_sys_latch, 0, PSI_DOCUMENT_ME),
#endif /* HYU */
};
...
#ifdef HYU
	,PSI_KEY(vdriver_dead_thread, 0, 0, PSI_DOCUMENT_ME)
	,PSI_KEY(vdriver_cut_thread, 0, 0, PSI_DOCUMENT_ME)
	,PSI_KEY(vdriver_stats_thread, 0, 0, PSI_DOCUMENT_ME)
#endif
};
