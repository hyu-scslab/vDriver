...
#ifdef HYU
mysql_pfs_key_t vdriver_dead_thread_key;
mysql_pfs_key_t vdriver_cut_thread_key;
mysql_pfs_key_t vdriver_stats_thread_key;
#endif
...
#ifdef HYU /* srv_start_threads : start vdriver cut thread */
  srv_threads.m_vdriver_dead = 
	  os_thread_create(vdriver_dead_thread_key, vdriver_dead_thread);

  srv_threads.m_vdriver_dead.start();

  srv_threads.m_vdriver_cut = 
      os_thread_create(vdriver_cut_thread_key, vdriver_cut_thread);

  srv_threads.m_vdriver_cut.start();

  srv_threads.m_vdriver_stats =
	  os_thread_create(vdriver_stats_thread_key, vdriver_stats_thread);

  srv_threads.m_vdriver_stats.start();
#endif
...
#ifdef HYU
	  ,{"vdriver_dead", srv_threads.m_vdriver_dead,
          std::bind(os_event_set, srv_vdriver_dead_event), SRV_SHUTDOWN_CLEANUP}
      ,{"vdriver_cut", srv_threads.m_vdriver_cut,
          std::bind(os_event_set, srv_vdriver_cut_event), SRV_SHUTDOWN_CLEANUP}
      ,{"vdriver_stats", srv_threads.m_vdriver_stats,
          std::bind(os_event_set, srv_vdriver_stats_event), SRV_SHUTDOWN_CLEANUP}
